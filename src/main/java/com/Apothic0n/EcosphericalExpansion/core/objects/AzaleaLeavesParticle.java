...
public class AzaleaLeavesParticle extends TextureSheetParticle {
    ...
    public AzaleaLeavesParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet) {
        super(level, x, y, z);
