...
public class ECOVegetationPlacements {
    ...
    public static final PlacedFeature TREES_SPARSE_MEGA_ACACIA = PlacementUtils.register("eco:trees_sparse_mega_acacia", ECOVegetationFeatures.TREES_SPARSE_MEGA_ACACIA.placed(RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
    ...
    public static final PlacedFeature TREES_RARE_NORMAL_DARK_OAK = PlacementUtils.register("eco:trees_rare_normal_dark_oak", ECOVegetationFeatures.TREES_RARE_NORMAL_DARK_OAK.placed(treePlacement(PlacementUtils.countExtra(1, 0.2F, 1))));
    ...
    public static final PlacedFeature BASALT_RUBBLE = PlacementUtils.register("eco:basalt_rubble", ECOVegetationFeatures.BASALT_RUBBLE.placed(treePlacement(PlacementUtils.countExtra(2, 0.2F, 1))));
