...
public class LargePackedIcePillarFeature extends Feature<LargeDripstoneConfiguration> {
    ...
    private static LargePillar makeIce(BlockPos pRoot, boolean pPointingUp, Random pRandom, int pRadius, FloatProvider pBluntnessBase, FloatProvider pScaleBase) {
    ...
    static final class LargePillar {
        ...
        void placeBlocks(WorldGenLevel pLevel, Random pRandom, WindOffsetter pWindOffsetter, int pRadius) {
