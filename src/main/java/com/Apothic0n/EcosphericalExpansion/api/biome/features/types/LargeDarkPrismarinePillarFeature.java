...
public class LargeDarkPrismarinePillarFeature extends Feature<LargeDripstoneConfiguration> {
    public LargeDarkPrismarinePillarFeature(Codec<LargeDripstoneConfiguration> pContext) {
        super(pContext);
    }
