...
public class LargeBlackstonePillarFeature extends Feature<LargeDripstoneConfiguration> {
    ...
    private static LargePillar makeBlackstone(BlockPos pRoot, boolean pPointingUp, Random pRandom, int pRadius, FloatProvider pBluntnessBase, FloatProvider pScaleBase) {
