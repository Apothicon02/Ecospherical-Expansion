...
public class LargeCalcitePillarFeature extends Feature<LargeDripstoneConfiguration> {
    ...
    private static LargePillar makeCalcite(BlockPos pRoot, boolean pPointingUp, Random pRandom, int pRadius, FloatProvider pBluntnessBase, FloatProvider pScaleBase) {
